...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><i class="ico-file mr10"></i>Edit Unit Place</h3>

        </div>
        <!--/ panel heading/header -->
        <form action="{{ route('unitplaces.update',$unitplace->id) }}" method="post" class="form-horizontal" data-parsley-validate>
            <!-- panel body with collapse capabale -->{{ method_field('PUT') }}
            <div class="panel-body" id="settings">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-left" for="name">Unit Place Name:</label>
                            <div class="col-sm-9">
                                <input type="text" name="name" id="name" class="form-control input-sm" value="{{ $unitplace->name }}" data-parsley-required>
                                @if($errors->has('name'))
