...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><i class="ico-file mr10"></i>Add A New Unit Place</h3>

        </div>
        <!--/ panel heading/header -->
        <form action="{{ route('unitplaces.store') }}" method="post" class="form-horizontal" data-parsley-validate>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" id="name" class="form-control input-sm" data-parsley-required>
                                @if($errors->has('name'))
