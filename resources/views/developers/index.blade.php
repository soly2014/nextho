    ...
    <div class="panel panel-default form-horizontal">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-toolbar text-right">
                <a href="{{ route('developers.create') }}" class="btn btn-sm btn-default"><i class="ico-plus"></i> Add New Item</a>
            </div>
        </div>
        <!--/ panel heading/header -->
                                ...
                                <div class="toolbar">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('developers.edit', array($item->id)) }}"><i class="icon ico-pencil"></i>Edit</a></li>
                                            <li class="divider"></li>
                                            @if($item->published)
                                                <li><a href="{{ url('developers/publish').'/'.$item->id.'/0' }}" class="text-danger warn-first"><i class="icon ico-eye-close"></i>Un-Publish</a></li>
                                            @else
                                            <li><a href="{{ url('developers/publish').'/'.$item->id.'/1'  }}" class="text-primary confirm-first"><i class="icon ico-eye"></i>Publish</a></li>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
