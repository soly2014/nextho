...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><i class="ico-file mr10"></i>Add A New Developer</h3>

        </div>
        <!--/ panel heading/header -->
        <form action="{{ route('developers.store') }}" method="post" class="form-horizontal" data-parsley-validate>
