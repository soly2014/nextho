            ...
            <table class="table table-bordered table-hover responsive" id="Leads_Table">
                ...
                <tbody>
                    ...
                    @foreach($forecasts as $forecast)
                        <tr>
                            ...
                            <td>{{ $forecast->associatedRole->role_name }}</td>
                            <td>{{ $forecast->userCreated->username}}</td>
                            <td>
                                <div class="toolbar">
                                    <div class="btn-group">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th><input type="search" class="form-control" name="search_engine" placeholder="Year"></th>
                        <th><input type="search" class="form-control" name="search_engine" placeholder="Amount"></th>
