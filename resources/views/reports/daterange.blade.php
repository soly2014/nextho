...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <!--/ panel heading/header -->
        <form action="{{ route('report-daily-repot-post') }}" method="post" class="form-horizontal" data-parsley-validate>
                 ...
                 <div class="row">
                     <div class="col-sm-6">
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {{ Form::text('end_date', null, ['id' => 'end_date', 'class' => 'form-control input-sm full-date-picker']) }}
                            </div>
                        </div>
                     </div>
                     <div class="col-sm-6">
                         <div class="form-group">
                            <label class="col-sm-3 control-label" for="assigned_to">Agent(s):</label>
                            <div class="col-sm-9">
                                {{ Form::select('agents[]', $users, 0, array('class' => 'form-control input-sm', 'multiple')); }}
                            </div>
                        </div>
                     </div>
                 </div>
