                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a data-toggle="collapse" data-parent="#accordion1" href="#collapseOne" class="collapsed">
                                    <span class="arrow mr5"></span> Generate Report
                                </a>
                            </h4>
                            </div>
                                <div class="panel-body">
                                    <div class="col-sm-12">
                                        <form action="{{ route('new-report-generate') }}" method="get" class="form-horizontal" data-parsley-validate>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    @if($errors->has('name'))
                                            ...
                                            <div class="panel-footer">
                                                <div class="form-group no-border">
                                                    <label class="col-sm-3 control-label">Generate Report</label>
                                                    <div class="col-sm-9">
                                                        <button name="submit" value="save" type="submit" class="btn btn-primary">Generate</button>
