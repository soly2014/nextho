    ...
    <div class="panel panel-default form-horizontal">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-toolbar text-right">
                <a href="{{ route($create_route) }}" class="btn btn-sm btn-default"><i class="ico-plus"></i> Add New Item</a>
            </div>
        </div>
        <!--/ panel heading/header -->
            ...
            <table class="table table-bordered table-hover responsive" id="Leads_Table">
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td>{{ $item->userCreated->username }}</td>
                                ...
                                <div class="toolbar">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route($modify_route, array($item->id)) }}"><i class="icon ico-pencil"></i>Edit</a></li>
                                            <li class="divider"></li>
                                            @if($item->published)
                                                <li><a href="{{ route($unpublish_route, array($item->id)) }}" class="text-danger warn-first"><i class="icon ico-eye-close"></i>Un-Publish</a></li>
                                            @else
                                            <li><a href="{{ route($publish_route, array($item->id)) }}" class="text-primary confirm-first"><i class="icon ico-eye"></i>Publish</a></li>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th><input type="search" class="form-control" name="search_engine" placeholder="Sort Order"></th>
